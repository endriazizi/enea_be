# 🧾 PROJECT SNAPSHOT (lite) — scope: .

**Root:** /c/Users/Endri Azizi/progetti-dev/my_dev/be

Esclusi (dir): package-lock.json,node_modules,logs,exports,assets,.git,dist,.angular,.vscode,coverage,migrations,src/db/migrations

Esclusi (file): comandi_note.md,export-project-lite.sh,note.md,noteeee.md,package-lock.json,print.js

Estensioni incluse: ts,js,html,scss,css,json,md,xml,sql

_Generato: Sat, Jan 31, 2026  2:58:55 PM_
